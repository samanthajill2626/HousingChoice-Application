// GroupTextsCard - the "Relay groups" card shared by TenantFile and
...
/** A row's label: other members' names > tag > pool number > "Relay group". */
  ...
  return (
    <Card title="Relay groups">
      {pending ? (
        ...
        <EmptyRow>No relay groups yet.</EmptyRow>
      ) : (
        groups.map((g) => {
          return (
            <Row
