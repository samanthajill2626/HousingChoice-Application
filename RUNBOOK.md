...
**Relay opt-out attention index (2026-08-18, branch `fix/prod-warn-sweep`) - NOT YET APPLIED anywhere. Same shape and same ORDER as the unread index above: schema, then code, then a one-time backfill.**
