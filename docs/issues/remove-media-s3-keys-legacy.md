...
area: app/messages
created: 2026-06-18
refs: app/src/repos/messagesRepo.ts:238, app/src/routes/api.ts, dashboard/src/api/types.ts:429, dashboard-legacy/src/api/types.ts:184
---
...
- the mirrored field in `dashboard/src/api/types.ts` and `dashboard-legacy/.../types.ts`
  (legacy is retiring anyway) + `MessageBubble.tsx`.
