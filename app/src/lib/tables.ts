...
export const TABLES: readonly TableSpec[] = [
  ...
  },
  {
    ...
    gsis: [
      ...
      // resetUnread / setUnread (+ the relay-close and contact-delete resets),
      // so unread discovery costs O(actual unread) instead of a walk of the
      // whole open partition. The HASH value is the CONSTANT string 'unread' - encoding
