// Inline SVG icons — NO external icon font/CDN (CSP: default-src 'self', and we
// ship no network icon dependency). Each icon is a small currentColor SVG, so
// it tints with the surrounding text/button color. Add to this set as feature
// screens need more glyphs; keep them stroke-based 24x24 for consistency.
