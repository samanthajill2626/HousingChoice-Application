...
const COLD_SHELL_GETS = Object.freeze([
  ...
  // are now distinct, so a page read can no longer be mistaken for shell work.
  required('/api/inbox/unread-count', [], 'inbox_badge'),
...
export const CONTRACT_SOURCE_LEDGER = Object.freeze({
  endpoints: Object.freeze({
    ...
    'inbox-unknown': { base: 'dashboard/src/routes/inbox/useInbox.ts:48-75,157-176' },
    'inbox-groups': { base: 'dashboard/src/routes/inbox/useInbox.ts:48-75,157-176' },
  ...
  background: Object.freeze({
    ...
    tourChannels: 'dashboard/src/routes/tours/useTourChannels.ts:102,228-255',
    placementChannels: 'dashboard/src/routes/placements/usePlacementChannels.ts:103,236-263',
