...
// type-agnostic — Details (phones, status), Preferences & notes, any Cases, and
...
import { tenantCases } from './buildContactFile.js';
...
export function UnknownFile({
  ...
  // Cases that reference this contact (none expected for a fresh inbound, but show
