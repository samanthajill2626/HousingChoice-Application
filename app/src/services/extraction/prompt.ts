...
export function buildExtractionSystemPrompt(): string {
  ...
  return [
    ...
    `  ${vocab}`,
    '  If the client names an authority that is NOT on that list, still SURFACE it:',
    '  keep housingAuthority op "none" AND add a noteLine of the form',
    '  "Housing authority stated: <exactly what they said>". Never drop a stated',
    '  authority silently - an unlisted one is news to a human, not a non-answer.',
